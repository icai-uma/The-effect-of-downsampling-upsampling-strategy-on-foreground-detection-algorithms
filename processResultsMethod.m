    ...
    for NdxTypeDownsampling=1:NumTypeDownsamplings
        for NdxResizeFactor=1:NumResizeFactors
            ...
            for NdxTypeUpsampling=1:NumTypeUpsamplings
                params.PathResultsUpsamplingFile = strcat(params.MatlabProjectsDirectory,'resizeStudy/',sprintf('resultsUpsampling_%d_%d_%d_%d_%d.mat',NdxVideo,NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling));
...
save(strcat(params.MatlabProjectsDirectory,'resizeStudy/','joinedResultsSegmentation_',selectedMethod,'.mat'),'resultsSegmentation');
save(strcat(params.MatlabProjectsDirectory,'resizeStudy/','joinedResultsUpsampling_',selectedMethod,'.mat'),'resultsUpsampling');
save(strcat(params.MatlabProjectsDirectory,'resizeStudy/','joinedResultsStats_',selectedMethod,'.mat'),'resultsStats');