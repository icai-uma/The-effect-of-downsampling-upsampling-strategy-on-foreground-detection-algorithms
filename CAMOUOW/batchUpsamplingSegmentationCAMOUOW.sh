...
#SBATCH -J batchUpsamplingSegmentationCAMOUOW.sh
...
##SBATCH --array=1-6240
## NumVideos * NumResizeFactors * NumTypeDownsamplings = 4*7*4 = 280 (modificar createConfigCAMOUOW.m para cada NdxTypeUpsampling)
#SBATCH --array=1-280
...
matlab -nodisplay -nodesktop -nojvm -singleCompThread -r "try;run('./upsamplingSegmentationCAMOUOW.m');end;"
