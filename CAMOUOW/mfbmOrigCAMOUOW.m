...
if exist(params.PathCodeResultsSegmentationFile) == 2 %file exists
	...
	VideoFrame=double(imread(sprintf(strcat(params.PathDatasetResized,'/%d.png'),params.deltaFrame+1)));
    ...
    for NdxFrame=2:model.NumPatterns
        VideoFrame=double(imread(sprintf(strcat(params.PathDatasetResized,'/%d.png'),NdxFrame)));
        %%%clearvars VideoFrame
