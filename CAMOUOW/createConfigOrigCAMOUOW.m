...
elseif exist('isUpsampling','var') % hay que cambiarlo cuando se ejecuta el upsampling y las stats
    NdxMethod = 1; % hay que cambiarlo manualmente para cada metodo!!!!
...
params.PathDatasetResized = strcat(params.MatlabProjectsDirectory,'resizeStudyCAMOUOW/datasetResized/',sprintf('%d-%d/',NdxResizeFactor,NdxTypeDownsampling),VideoFileSpec{NdxVideo},'/');
