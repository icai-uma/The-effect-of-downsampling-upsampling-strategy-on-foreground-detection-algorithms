% execute in Windows
function []=processResultsMethodOrigCAMOUOW(selectedMethod)
...
save(strcat(params.MatlabProjectsDirectory,'resizeStudyCAMOUOW/','joinedResultsSegmentation_',selectedMethod,'_orig.mat'),'resultsSegmentation');
save(strcat(params.MatlabProjectsDirectory,'resizeStudyCAMOUOW/','joinedResultsStats_',selectedMethod,'_orig.mat'),'resultsStats');