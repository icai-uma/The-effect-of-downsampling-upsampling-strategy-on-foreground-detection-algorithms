...
%NdxVideo = 8; NdxResizeFactor = 6; NdxTypeDownsampling=4; NdxTypeUpsampling=1;
...
elseif exist('isUpsampling','var') % hay que cambiarlo cuando se ejecuta el upsampling y las stats
    NdxMethod = 10; % hay que cambiarlo manualmente para cada metodo!!!!
...
if exist('isUpsampling','var')
    params.PathDatasetResults = strcat(params.MatlabProjectsDirectory,'resizeStudyCAMOUOW/methods/',sprintf('%d-%d-%d-%d/',NdxMethod,NdxResizeFactor,NdxTypeDownsampling,1),'results/',VideoFileSpec{NdxVideo});
    params.PathDatasetSegmented = strcat(params.MatlabProjectsDirectory,'resizeStudyCAMOUOW/methods/',sprintf('%d-%d-%d-%d/',NdxMethod,NdxResizeFactor,NdxTypeDownsampling,1),'segmentation/',VideoFileSpec{NdxVideo},'/bin%06d.png');
    ...
    params.PathDatasetResults = strcat(params.MatlabProjectsDirectory,'resizeStudyCAMOUOW/methods/',sprintf('%d-%d-%d-%d/',NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling),'results/',VideoFileSpec{NdxVideo});
    params.PathResultsUpsamplingFile = strcat(params.PathDatasetResults,sprintf('/resultsUpsampling_%d_%d_%d_%d_%d.mat',NdxVideo,NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling));
    params.PathDatasetSegmentation = strcat(params.MatlabProjectsDirectory,'resizeStudyCAMOUOW/methods/',sprintf('%d-%d-%d-%d/',NdxMethod,NdxResizeFactor,NdxTypeDownsampling,1),'segmentation/',VideoFileSpec{NdxVideo});
end
