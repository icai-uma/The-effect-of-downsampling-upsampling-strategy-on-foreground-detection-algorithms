...
save(strcat(params.MatlabProjectsDirectory,'resizeStudy4k/','joinedResultsSegmentation_',selectedMethod,'_orig.mat'),'resultsSegmentation');
save(strcat(params.MatlabProjectsDirectory,'resizeStudy4k/','joinedResultsStats_',selectedMethod,'_orig.mat'),'resultsStats');