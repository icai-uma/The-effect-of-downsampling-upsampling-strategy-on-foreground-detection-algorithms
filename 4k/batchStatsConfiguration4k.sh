...
#SBATCH -J batchStatsConfiguration4k.sh
...
##SBATCH --array=1-6240
## NumVideos * NumResizeFactors * NumTypeDownsamplings = 4*7*4 = 112 
#SBATCH --array=1-112
...
matlab -nodisplay -nodesktop -nojvm -singleCompThread -r "try;run('./statsConfiguration4k.m');end;"
