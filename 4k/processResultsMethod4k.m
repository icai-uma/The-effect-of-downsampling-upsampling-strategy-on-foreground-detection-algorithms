...
for NdxVideo=1:NumVideos
    for NdxTypeDownsampling=1:NumTypeDownsamplings
        for NdxResizeFactor=1:NumResizeFactors
            NdxTypeUpsampling = 1;
            params.PathResultsSegmentationFile = strcat(params.MatlabProjectsDirectory,'resizeStudy4k/',sprintf('resultsSegmentation_%d_%d_%d_%d_%d.mat',NdxVideo,NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling));            
            ...
            for NdxTypeUpsampling=1:NumTypeUpsamplings
                params.PathResultsUpsamplingFile = strcat(params.MatlabProjectsDirectory,'resizeStudy4k/',sprintf('resultsUpsampling_%d_%d_%d_%d_%d.mat',NdxVideo,NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling));
                params.PathResultsStatsFile = strcat(params.MatlabProjectsDirectory,'resizeStudy4k/',sprintf('resultsStats_%d_%d_%d_%d_%d.mat',NdxVideo,NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling));
...
save(strcat(params.MatlabProjectsDirectory,'resizeStudy4k/','joinedResultsSegmentation_',selectedMethod,'.mat'),'resultsSegmentation');
save(strcat(params.MatlabProjectsDirectory,'resizeStudy4k/','joinedResultsUpsampling_',selectedMethod,'.mat'),'resultsUpsampling');
save(strcat(params.MatlabProjectsDirectory,'resizeStudy4k/','joinedResultsStats_',selectedMethod,'.mat'),'resultsStats');