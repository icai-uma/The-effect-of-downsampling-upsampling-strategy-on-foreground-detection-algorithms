...
for NdxVideo=1:NumVideos    
    for NdxTypeDownsampling=1:NumTypeDownsamplings
        for NdxResizeFactor=1:NumResizeFactors
            params.PathResultsDownsamplingFile = strcat(params.MatlabProjectsDirectory,'resizeStudy4k/',sprintf('resultsDownsampling_%d_%d_%d.mat',NdxVideo,NdxResizeFactor,NdxTypeDownsampling));
...
save(strcat(params.MatlabProjectsDirectory,'resizeStudy4k/','joinedResultsDownsampling.mat'),'resultsDownsampling');