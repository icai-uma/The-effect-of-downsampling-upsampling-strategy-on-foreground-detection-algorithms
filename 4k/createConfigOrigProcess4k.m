...
elseif exist('isUpsampling','var') % hay que cambiarlo cuando se ejecuta el upsampling y las stats
    NdxMethod = 5; % hay que cambiarlo manualmente para cada metodo!!!!
...
params.VideoPath = strcat(params.MatlabProjectsDirectory,'datasets/dataset2014/dataset4k/',VideoFileSpec{NdxVideo},'/');
