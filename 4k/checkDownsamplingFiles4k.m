...
for NdxResizeFactor = 1:NumResizeFactors
    for NdxTypeDownsampling = 1:NumTypeDownsamplings
        for NdxVideo=1:NumVideos
            pathDatasetResized = strcat(params.MatlabProjectsDirectory,'resizeStudy4k/datasetResized/',sprintf('%d-%d/',NdxResizeFactor,NdxTypeDownsampling),VideoFileSpec{NdxVideo},'/frames.mat');
