...
TypeDownsampling = [1 2 3 4 5]; % {imresize ('nearest', 'bicubic', 'bilinear'), imfilter}
        ...
        for NdxResizeFactor=1:NumResizeFactors
            ...
            for NdxMethod=1:NumMethods
                for NdxTypeUpsampling=1:NumTypeUpsamplings
                    ...
                    if NdxVideo==10 & NdxMethod==1 & NdxResizeFactor==2 & NdxTypeDownsampling==2 & NdxTypeUpsampling==1
                        disp(NdxVideo);
                    end
...
save('resultsDownsampling.mat','resultsDownsampling');
save('resultsSegmentation.mat','resultsSegmentation');
save('resultsUpsampling.mat','resultsUpsampling');
save('resultsStats.mat','resultsStats');