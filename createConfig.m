...
[NdxVideo,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling,NdxMethod]=ind2sub([NumVideos NumResizeFactors NumTypeDownsamplings NumTypeUpsamplings NumMethods],ArrayIDNumber);
...
elseif exist('isUpsampling','var') % hay que cambiarlo cuando se ejecuta el upsampling y las stats
    NdxMethod = 11; % hay que cambiarlo manualmente para cada metodo!!!!
...
params.VideoFileSpec = strcat(params.MatlabProjectsDirectory,'datasets/dataset2014/dataset/',VideoFileSpec{NdxVideo},'/input/in%06d.jpg');
params.PathDatasetGT = strcat(params.MatlabProjectsDirectory,'datasets/dataset2014/dataset/',VideoFileSpec{NdxVideo},'/groundtruth/gt%06d.png');
params.PathDatasetVideoROI = strcat(params.MatlabProjectsDirectory,'datasets/dataset2014/dataset/',VideoFileSpec{NdxVideo},'/temporalROI.txt');
params.PathDatasetResized = strcat(params.MatlabProjectsDirectory,'resizeStudy/datasetResized/',sprintf('%d-%d/',NdxResizeFactor,NdxTypeDownsampling),VideoFileSpec{NdxVideo},'/input/');
params.PathDatasetSegmented = strcat(params.MatlabProjectsDirectory,'resizeStudy/methods/',sprintf('%d-%d-%d-%d/',NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling),'segmentation/',VideoFileSpec{NdxVideo},'/bin%06d.png');
params.PathDatasetUpsampled = strcat(params.MatlabProjectsDirectory,'resizeStudy/methods/',sprintf('%d-%d-%d-%d/',NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling),'upsampling/',VideoFileSpec{NdxVideo},'/bin%06d.png');
params.PathDatasetResults = strcat(params.MatlabProjectsDirectory,'resizeStudy/methods/',sprintf('%d-%d-%d-%d/',NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling),'results/',VideoFileSpec{NdxVideo});
params.PathDatasetSegmentation = strcat(params.MatlabProjectsDirectory,'resizeStudy/methods/',sprintf('%d-%d-%d-%d/',NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling),'segmentation/',VideoFileSpec{NdxVideo});
params.PathDatasetUpsampling = strcat(params.MatlabProjectsDirectory,'resizeStudy/methods/',sprintf('%d-%d-%d-%d/',NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling),'upsampling/',VideoFileSpec{NdxVideo});
params.pathConfigFile = strcat(params.MatlabProjectsDirectory,'resizeStudy/methods/',sprintf('%d-%d-%d-%d/',NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling),sprintf('config_%d_%d_%d_%d_%d.mat',NdxVideo,NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling));
...
if exist('isUpsampling','var')
    params.PathDatasetResults = strcat(params.MatlabProjectsDirectory,'resizeStudy/methods/',sprintf('%d-%d-%d-%d/',NdxMethod,NdxResizeFactor,NdxTypeDownsampling,1),'results/',VideoFileSpec{NdxVideo});
    params.PathDatasetSegmented = strcat(params.MatlabProjectsDirectory,'resizeStudy/methods/',sprintf('%d-%d-%d-%d/',NdxMethod,NdxResizeFactor,NdxTypeDownsampling,1),'segmentation/',VideoFileSpec{NdxVideo},'/bin%06d.png');
    ...
    params.PathDatasetResults = strcat(params.MatlabProjectsDirectory,'resizeStudy/methods/',sprintf('%d-%d-%d-%d/',NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling),'results/',VideoFileSpec{NdxVideo});
    params.PathResultsUpsamplingFile = strcat(params.PathDatasetResults,sprintf('/resultsUpsampling_%d_%d_%d_%d_%d.mat',NdxVideo,NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling));
    params.PathDatasetSegmentation = strcat(params.MatlabProjectsDirectory,'resizeStudy/methods/',sprintf('%d-%d-%d-%d/',NdxMethod,NdxResizeFactor,NdxTypeDownsampling,1),'segmentation/',VideoFileSpec{NdxVideo});
end
params.PathCodeResultsDownsamplingFile = strcat(params.MatlabProjectsDirectory,'resizeStudy/',sprintf('resultsDownsampling_%d_%d_%d.mat',NdxVideo,NdxResizeFactor,NdxTypeDownsampling));
params.PathCodeResultsSegmentationFile = strcat(params.MatlabProjectsDirectory,'resizeStudy/',sprintf('resultsSegmentation_%d_%d_%d_%d_%d.mat',NdxVideo,NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling));
params.PathCodeResultsUpsamplingFile = strcat(params.MatlabProjectsDirectory,'resizeStudy/',sprintf('resultsUpsampling_%d_%d_%d_%d_%d.mat',NdxVideo,NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling));
params.PathCodeResultsStatsFile = strcat(params.MatlabProjectsDirectory,'resizeStudy/',sprintf('resultsStats_%d_%d_%d_%d_%d.mat',NdxVideo,NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling));
