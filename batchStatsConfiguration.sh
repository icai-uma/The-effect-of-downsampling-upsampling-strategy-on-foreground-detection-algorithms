...
#SBATCH -J batchStatsConfiguration.sh
...
##SBATCH --array=1-6240
## NumVideos * NumResizeFactors * NumTypeDownsamplings * NumTypeUpsamplings = 31*7*4*2 = 1736 (modificar createConfig.m para cada NdxTypeUpsampling)
#SBATCH --array=1-868
...
matlab -nodisplay -nodesktop -nojvm -singleCompThread -r "try;run('./statsConfiguration.m');end;"
