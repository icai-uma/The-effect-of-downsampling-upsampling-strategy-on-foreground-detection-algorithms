...
VideoFileSpec{1}='../../../MiguelAngel/Videos/baseline/baseline/highway/input/in%06d.jpg';
deltaFrame{1}=1;
numFrames{1}=1700;
...
AutomatedTestBM(SelectedFeatures{NdxFeatureSort},VideoFileSpec{NdxVideo},deltaFrame{NdxVideo},numFrames{NdxVideo},epsilon(NdxEpsilon));
