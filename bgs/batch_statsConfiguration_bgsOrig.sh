...
#SBATCH -J batch_statsConfiguration_bgsOrig.sh
...
##SBATCH --array=1-6240
## NumVideos * NumResizeFactors * NumTypeDownsamplings = 31*7*4 = 868
#SBATCH --array=1-31
...
matlab -nodisplay -nodesktop -nojvm -singleCompThread -r "try;run('./statsConfiguration_bgsOrig.m');end;"
