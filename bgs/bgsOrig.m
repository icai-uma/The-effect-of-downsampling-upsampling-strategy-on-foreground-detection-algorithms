...
%%%%%%load(strcat(params.PathDatasetResized,'..','/frames.mat')); % load video frames
    ...
    videoPath = strcat(params.VideoPath,'input/');
    ...
    save(strcat(params.MatlabProjectsDirectory,'resizeStudy/',sprintf('segmentedFrames_%d_%d_%d_%d_%d.mat',NdxVideo,NdxMethod,NdxResizeFactor,NdxTypeDownsampling,NdxTypeUpsampling)), 'segmentedFrames','-v7.3');
